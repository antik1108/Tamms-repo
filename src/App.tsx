      ...
      <div className="relative z-10">
          ...
          >
            <div className="relative group">
              ...
              <img
                src={MAIN_IMAGE}
                alt="Tamanna"
                className="relative w-64 md:w-80 h-auto rounded-2xl grayscale brightness-90 shadow-2xl transition-all duration-700 group-hover:grayscale-0 group-hover:scale-[1.02]"
              />
            </div>
        ...
        <StorySection id="p4" center className="bg-gradient-to-b from-transparent via-stone-900/10 to-transparent">
          <div className="max-w-3xl px-8 text-center space-y-10">
            ...
            <Sparkles className="w-6 h-6 text-white mx-auto opacity-50" />
          </div>
        </StorySection>
        ...
        <StorySection id="p6" center>
          <div className="max-w-2xl px-8 text-center space-y-12">
